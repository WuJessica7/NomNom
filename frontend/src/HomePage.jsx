...
function Hero() {
    return(
        <div className="hero-section">
            ...
            <img className="appIcon1" alt="" src="App_Image.png" />
        </div>
    );
}
...
function Section2 () {
    return(
        <div className="section-2">
            ...
            <img className="appIcon2" alt="" src="App_Image.png" />
        </div>
    );
}
...
function Section3 (){
    return(
        <div className="section-3">
            ...
            <img className="appIcon3" alt="" src="App_Image.png" />
        </div>
    );
}
...
function Section4 () {
    return(
        <div className="section-4">
            ...
            <img className="appIcon4" alt="" src="App_Image.png" />
        </div>
    );
}
